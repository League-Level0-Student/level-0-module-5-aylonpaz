...
public class Code4Life {
	...
	// write code instead.
	int hoursfr = Integer.parseInt(hours);
	if(hoursfr <= 2) {
		JOptionPane.showMessageDialog(null, "Stop watching Tiktok and write code instead.");
	}
	else if(hoursfr >=3 && hoursfr <= 5) {
		JOptionPane.showMessageDialog(null, "You are the best coder ever. You should drop out of highschool to pursue your coding influencer brand live in your parents basement at 30 years "
				+ "old.");
	}
	else if(hoursfr > 5) {
		playBatmanTheme();
